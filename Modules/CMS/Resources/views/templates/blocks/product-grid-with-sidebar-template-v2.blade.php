<section class="container mx-auto my-10 md:my-12"
    style="margin-top:{{ $component->mt }};margin-bottom:{{ $component->mb }};">
    <div class="flex md:justify-center justify-center items-center mb-2.5 md:mb-5">
        ...
        {{-- @if ($component && $component->see_more && $component->more_link) --}}
            {{-- <a href="#"
                class="process-goto  justify-center text-gray-10 font-medium text-base dm-sans hidden md:inline-flex items-center dm-sans hover:text-gray-12 trans-2">
    ...
    <div class="md:flex grid grid-cols-2 gap-4 clear-both">
