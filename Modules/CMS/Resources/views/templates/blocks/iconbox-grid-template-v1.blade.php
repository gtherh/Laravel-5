...
<div class="   lg:grid {{ $component->sidebox_show == 1 ? 'grid-cols-3' : '' }} gap-5 container mx-auto md:my-6 my-10 h-auto"
    style="margin-top:{{ $component->mt }};margin-bottom:{{ $component->mb }};">
    <div class="col-span-2 mt-5"
        style="border-radius: {{ $component->rounded == 1 ? '6px' : '0' }};">
        <div class=" grid grid-cols-4 sm:grid-cols-{{ $totalBoxes }} justify-items-center">
    ...
    @if ($component->sidebox_show == 1)
        ...
        @endphp
        <div class="col-span-1  bg-gray-12 {{ $component->rounded == 1 ? 'rounded-md' : '' }} p-15p">
