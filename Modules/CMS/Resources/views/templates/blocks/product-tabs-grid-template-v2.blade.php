@if (is_array($component->disp_categories))
    <section class="container mx-auto md:my-12 my-10"
                ...
                @foreach ($component->disp_categories as $type)
                    <div class="c-tab {{ $loop->iteration == 1 ? 'is-active' : '' }}">
                        <div class="c-tab__content">
                            <div class="grid lg:grid-cols-5 md:grid-cols-4 grid-cols-2 lg:gap-8 justify-items-center ">
                                <div>
                                    <div class="skeleton-box bg-gray-11 rev-img  relative">
