        ...
        <div class="my-4 flex flex-wrap md:justify-start gap-3 mt-5">
            ...
            @if (!$product->isExternalProduct() && isset($meta['individual_sale']) && $meta['individual_sale'] == 0)
                <div class="flex justify-start items-center gap-2 lg:gap-0">
                    ...
                    <div class="flex flex-wrap w-36 lg:w-135p h-10 lg:h-54p text-xl border rounded-3xl"
            ...
            @endif
                ...
                @if ($product->isExternalProduct())
                    ...
                    <div class="w-full">
                        <a href="{{ $external_products['url'] }}" target="_blank">
                            <button
                                class="primary-bg-color font-bold w-full h-54p py-3  2xl:p-2 rounded-full flex justify-center items-center">
                ...
                @else
                    <a href="javascript:void(0)" class="add-to-cart cart-details-page" id="item-add-to-cart"
                        data-itemCode={{ $code }}>
                        <button
                            class="black-bg-color font-bold py-2 px-12 rounded-full flex justify-center items-center" style="background:#000 !important">
                            <svg class="text-white" width="20" height="19" viewBox="0 0 20 19" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span
                                class="pl-2 p-5p dm-bold font-bold text-white text-lg">{{ __('Add to Cart') }}</span>
                        </button>
                    </a>
                @endif
