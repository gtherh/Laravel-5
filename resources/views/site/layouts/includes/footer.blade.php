...
@if ($count)
    ...
    {{-- <section class="bg-gray-12 text-white mt-5" style="color: #fff; background: #111"> --}}
        <footer class="body-font pb-30p sm:pb-11 container mx-auto">
            <div class="flex flex-wrap lg:flex-nowrap gap-7 pt-12 {{ $direction[$footer['main']['direction']] }}">
                @if (isset($footer['main']['about_us']['status']) && $footer['main']['about_us']['status'] == 1)
                    ...
                    <div class=" w-96 order-{{ isset($footer['main']['about_us']['sort']) ? $footer['main']['about_us']['sort'] : 1 }}">
                            ...
                            @if ($footerLogo->objectFile)
                                <div class="flex">
                                    <a href="{{ route('site.index') }}">
                                        ...
                                        <img class="w-44" height="30.14px" src="http://dev.samvalley.co/public/svg/White.svg" alt="{{ __('Image') }}">
                                    </a>
                                </div>
                            @endif
                        ...
                        <div class="mt-2">
                            ...
                            <div class="flex space-x-2 md:flex-row md:space-x-0 c-flex gap-2" >
                                @if ($googlePlay->objectFile)
                                    <div class="flex xs:justify-center md:justify-start">
                                        <a href="{{ isset($footer['main']['about_us']['data']['google_play_link']) ? $footer['main']['about_us']['data']['google_play_link'] : '' }}" class="mt-15p" target="_blank">
                                            ...
                                            <img class="w-263p sm:w-32" src="http://dev.samvalley.co/public/uploads/20230725/Apple(1).svg" alt="{{ __('Image') }}">
                                        </a>
                                    </div>
                                @endif
                                @if ($appStore->objectFile)
                                    <div class="flex xs:justify-center md:justify-start">
                                        <a href="{{ isset($footer['main']['about_us']['data']['app_store_link']) ? $footer['main']['about_us']['data']['app_store_link'] : '' }}" class="md:mt-15p mt-15p" target="_blank">
                                            {{-- <img class="w-263p sm:w-32" src="{{ $appStore->fileUrl() }}" alt="{{ __('Image') }}"> --}}
                                            <img class="w-263p sm:w-32" src="http://dev.samvalley.co/public/uploads/20230725/Google.svg" alt="{{ __('Image') }}">
                                        </a>
                                    </div>
                                @endif
                            </div>
...
{{-- <section style="color: #eee; background: #000">     --}}
@if ($footer['bottom']['status'])
<div class="max-w-full md:max-w-screen-lg lg:max-w-screen-xl xl:max-w-screen-2xl h-auto p-3.5 flex flex-col md:flex-row justify-center items-center md:gap-35px">
    <p class="md:py-3 py-7 font-medium dm-sans text-{{ isset($footer['bottom']['position']) ? $footer['bottom']['position'] : '' }}">
        ©{{ date('Y')}} Sam Valley | All Rights Reserved
    </p>
    <span class="flex md:ml-4 mt-4 md:mt-0">
        <a href="#" class="px-4 py-2 text-white text-sm font-medium dm-sans hover:text-gray-300">terms of use</a>
        <a href="#" class="px-4 py-2 text-white text-sm font-medium dm-sans hover:text-gray-300">terms of sale</a>
        <a href="#" class="px-4 py-2 text-white text-sm font-medium dm-sans hover:text-gray-300">policy and privacy</a>
        <a href="#" class="px-4 py-2 text-white text-sm font-medium dm-sans hover:text-gray-300">warranty policy</a>
    </span>
</div>
<div class=" mx-auto h-auto p-3.5 flex flex-col md:flex-row justify-center items-center md:gap-35px" style="background-color: #7F7573">
    <div class="flex justify-start items-center gap-2 md:gap-2.5">
      <div class="p-1 justify-center items-center flex">
        <div class="text-white text-xs font-normal leading-none">company name and type</div>
      </div>
      <div class="p-1 justify-center items-center flex">
        <div class="text-white text-xs font-normal leading-none">commercial registry</div>
      </div>
    </div>
    <div class="flex justify-start items-center gap-2 md:gap-2.5 mt-2 md:mt-0">
      <div class="p-1 justify-center items-center flex">
        <div><span class="text-white text-xs font-normal leading-none">tax number </span><span class="text-white text-xs font-normal leading-none">1286430098</span></div>
      </div>
      <div class="p-1 justify-center items-center flex">
        <div><span class="text-white text-xs font-normal leading-none">Company rights </span><span class="text-white text-xs font-normal leading-none">126537890543292</span></div>
      </div>
    </div>
  </div>
    @endif
