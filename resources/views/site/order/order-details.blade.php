            ...
            <div class="xl:w-1/5 w-full">
                <div class="flex flex-row xl:flex-col justify-between">
                    ...
                    <div class="xl:mt-10">
                     ...
                     <div class="xl:mt-10">
                        <p class="uppercase roboto-medium font-medium xl:text-lg text-15 lg:text-left text-right text-gray-10">{{ __('Track code') }}</p>
                        <h3 class="uppercase dm-bold font-bold text-gray-12 2xl:text-28 xl:text-2xl text-xl xl:text-left text-right">{{ isset($order->getMeta()['track_code']) ? $order->getMeta()['track_code'] : __('Unavailable') }}</h3>
                    </div>
                </div>
                    ...
                    <div class="flex lg:mt-11 mt-6">
                        <span class="mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="54" height="38" viewBox="0 0 54 38" fill="none">
                                <rect x="23.3567" y="22.9004" width="10.7315" height="10.7315" rx="2" fill="#72D2F5"/>
                    ...
                    <div class="flex mt-11">
                        <span class="mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="41" viewBox="0 0 56 41" fill="none">
                                <rect x="23.3569" y="17.9004" width="10.7315" height="10.7315" rx="2" fill="#72D2F5"/>
                                <rect y="0.225586" width="20.8318" height="20.8318" rx="2" fill="#72D2F5"/>
                    ...
                    <div class="flex mt-11">
                        <span class="mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="47" height="40" viewBox="0 0 47 40" fill="none">
                                <rect x="23.3569" y="17.6748" width="10.7315" height="10.7315" rx="2" fill="#72D2F5"/>
                                <rect width="20.8318" height="20.8318" rx="2" fill="#72D2F5"/>
