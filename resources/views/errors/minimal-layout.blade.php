                ...
                <div class="flex">
                    <div class="lg:ml-23p ml-21p mt-2.5 lg:mt-18p">
                      ...
                      <span class="relative ml-2p md:ml-0">
                        <svg class="w-11p h-11p md:w-15p md:h-15p" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none"><circle cx="7.5" cy="7.5" r="7.5" fill="#72D2F5" />
                        </svg>
                      </span>
