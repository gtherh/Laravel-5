                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5" id="formBlock">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="{{ __('Name') }}"
                                                    ...
                                                    name="name_en" required minlength="3"
                                        ...
                                        <div class="form-group row">
                                            <label for="name_ar" class="control-label require ps-3">{{ __('Name in Arabic') }}
                                            </label>
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="{{ __('Name in Arabic') }}"
                                                    class="form-control form-width inputFieldDesign" id="name_ar"
                                                    name="name_ar" required minlength="3"
...
@section('js')
    ...
    <script src="{{ asset('public/dist/js/custom/category.js') }}"></script>
@endsection
