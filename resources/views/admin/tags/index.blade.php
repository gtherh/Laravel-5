    ...
    <div class="col-sm-12 list-container" id="brand-list-container">
        <div class="card">
            <div class="card-header d-md-flex justify-content-between align-items-center">
                <h5> <a href="{{ route('tags.index') }}">{{ __('Tags') }}</a> </h5>
                <div class="d-md-flex justify-content-end align-items-center">
                    ...
                    @if (in_array('App\Http\Controllers\BrandController@create', $prms))
                        <a href="{{ route('tags.create') }}" class="btn btn-outline-primary mb-0 custom-btn-small">
                            <span class="fa fa-plus"> &nbsp;</span>{{ __('Add Tag') }}
                        </a>
                    @endif
