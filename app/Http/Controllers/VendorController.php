...
class VendorController extends Controller
{
    ...
    public function store(StoreVendorRequest $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($this->c_p_c()) {
                Session::flush();
                return view('errors.installer-error', ['message' => __("This product is facing license validation issue.<br>Please verify your purchase code from <a style=\"color:#72D2F5\" href=\"". route('purchase-code-check', ['bypass' => 'purchase_code']) ."\">here</a>.")]);
            }
